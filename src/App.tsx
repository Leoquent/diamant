        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative group/carousel">
            ...
            <button
              ...
              className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 z-20 bg-white p-3 rounded-full shadow-lg border border-gray-100 text-primary opacity-0 group-hover/carousel:opacity-100 transition-opacity hidden md:flex items-center justify-center cursor-pointer hover:bg-primary hover:text-white"
            ...
            <button
              ...
              className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 z-20 bg-white p-3 rounded-full shadow-lg border border-gray-100 text-primary opacity-0 group-hover/carousel:opacity-100 transition-opacity hidden md:flex items-center justify-center cursor-pointer hover:bg-primary hover:text-white"
            ...
            <div
              ref={reviewsRef}
              className="flex overflow-x-auto gap-4 sm:gap-6 pt-4 pb-8 snap-x snap-mandatory hide-scrollbar -mx-4 px-4 sm:mx-0 sm:px-0 scroll-smooth"
